...
export const sendResponse = (res: any, req: any, data: any, message: String, success: boolean, code: number) => {
    const responseObj = {
        data,
        message,
        success
...
export const sendError = (res: any, req: any, data: any, msg: String, code: number) => {
